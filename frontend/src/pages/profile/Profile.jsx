...
//useeffect y3ml run lel userprofile 
...
const { id } = useParams();
 ...
 useEffect(() => {
  dispatch(getUserProfile(id))
    window.scrollTo(0,0);  //ki nod5 lel page hedhi ytl3 lfou9 page tb9ach louta 
    } ,[id]);
...
const deleteAccountHandler = () => {
    ...
    .then((isOk) => {
      if (isOk) {
        ...
        dispatch(deleteProfile(user?._id)); //user ki yfs5 compte mt3ou y3ml logout 
        dispatch(logoutUser());
      } 
    });
